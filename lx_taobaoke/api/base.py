...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20190618"
...
class RestApi(object):
    ...
    def __init__(self, domain='gw.api.taobao.com', port = 80):
        ...
        if(lx_taobaoke.getDefaultAppInfo()):
            self.__app_key = lx_taobaoke.getDefaultAppInfo().appkey
            self.__secret = lx_taobaoke.getDefaultAppInfo().secret
    ...
    def set_app_info(self, appinfo):
        #=======================================================================
        # 设置请求的app信息
        # @param appinfo: import lx_taobaoke
        #                 appinfo lx_taobaoke.appinfo(appkey,secret)
        #=======================================================================
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        xxxx = self.__httpmethod
        return url, body, header
        connection.request(xxxx, url, body=body, headers=header)
